                ...
                oTable = $('#export-button').DataTable({
                    ...
                    "columns" : [
                        ...
                        { data : null, render: function (data, type,row) { 
                            ...
                            if(editOption) {
                                viewDiv = viewDiv+'<a href="#" data-pan="'+row.pan_number+'" class="dropdown-item re_evaluate_cams">Re Evaluate CAMS</a><a href="#" data-pan="'+row.pan_number+'" class="dropdown-item re_evaluate_karvy">Re Evaluate KARVY</a>';
                            }
