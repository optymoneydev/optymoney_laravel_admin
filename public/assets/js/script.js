(function ($) {
    ...
    $(".re_evaluate_cams").on('click', function() {
        var data = {"0":$(this).attr("data-pan")};
        $.ajax({
            url: APP_URL+"/api/mf/cams/camsByPAN",
            method: "POST",
            headers: {
    ...
    $(".re_evaluate_karvy").on('click', function() {
        var data = {"0":$(this).attr("data-pan")};
        $.ajax({
            url: APP_URL+"/api/mf/karvy/karvyByPAN",
            method: "POST",
            headers: {
                "content-type": "application/json",
                "cache-control": "no-cache"
