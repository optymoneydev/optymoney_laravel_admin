            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="49%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <tr><td> </td></tr>
                            <tr><td style="font-family:Verdana, Geneva, sans-serif; font-weight:600; font-size:15px;">Customer Details:</td></tr>
                ...
                <tr>
                    <td colspan="2"><table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border: 1px solid #eee">
                        ...
                        <tr>
                            <td style="padding: 5px;vertical-align: top;border: 1px solid #eee;">ucfirst({{$metalType}}) {{$karat}} {{$purity}}</td>
