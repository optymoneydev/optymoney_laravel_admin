				...
				<form class="needs-validation" novalidate="" id="saveSellOrderForm" action="{!!route('augmont.saveSellOrder')!!}" method="POST" >
					...
					<div class="card-body">
									...
									<div class="col px-auto aug-frame footer-border">
										...
										<div class="row  ">
											<div class="col-6 col-sm-4 col-md py-3">
												...
												<div class="dg-minibold"><span id="goldSellGrams">{{ $goldGrams }}</span> grams</div>
											</div>
											<div class="col-6 col-sm-4 col-md py-3">
												<h6 class="pb-2 ">Amount</h6>
												<div class="dg-minibold"><span class="rupees">₹</span><span id="goldSellAmount"> {{ $goldGrams * $goldPrice }}</span></div>
											</div>
										</div>
										<hr class="">
										<div class="row ">
						...
						<div class="mb-3">
							...
							<input class="form-control" id="quantity" name="quantity" type="hidden" placeholder="Quantity" required="required" value="{{ $goldGrams }}">
							<input class="form-control" id="blockId" name="blockId" type="hidden" placeholder="BlockId" required="required" value="{{ $goldBlockId }}">
							<input class="form-control" id="totalAmount" name="totalAmount" type="hidden" placeholder="Amount" required="required" value="{{ ($goldGrams * $goldPrice) }}">
						</div>
					</div>
