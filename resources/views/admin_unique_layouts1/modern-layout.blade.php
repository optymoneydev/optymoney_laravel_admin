...
<html lang="en">
  <head>
    ...
    <title>optymoney - Premium Admin Template - Seoul</title>
    <!-- Google font-->
  ...
  <body>
    ...
    <!-- tap on tap ends-->
    <!-- page-wrapper Start-->
    <div class="page-wrapper horizontal-wrapper modern-type" id="pageWrapper">
      <!-- Page Header Start-->
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list">
                    <label class="badge badge-success">5</label><a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}" href="#"><i data-feather="home"></i><span class="lan-3">{{ trans('lang.Dashboards') }}</span>
    ...
    <script type="text/javascript"> 
        localStorage.clear();
        $(".page-wrapper").attr("class", "page-wrapper horizontal-wrapper modern-type");
        localStorage.setItem('page-wrapper', 'horizontal-wrapper modern-type');
    </script>
  </body>
</html>