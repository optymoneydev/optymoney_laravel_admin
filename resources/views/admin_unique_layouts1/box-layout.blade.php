...
<html lang="en">
  <head>
    ...
    <title>Optymoney - Gold/Silver - New York</title>
    <!-- Google font-->
  ...
  <body>
    ...
    <!-- tap on tap ends-->
    <!-- page-wrapper Start-->
    <div class="page-wrapper horizontal-wrapper box-layout" id="pageWrapper">
      <!-- Page Header Start-->
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list">
                    <label class="badge badge-success">2234</label><a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}" href="#"><i data-feather="home"></i><span class="lan-3">{{ trans('lang.Dashboards') }}</span>
    ...
    <script type="text/javascript">
        localStorage.clear();
        $(".page-wrapper").attr("class", "page-wrapper horizontal-wrapper box-layout");
        localStorage.setItem('page-wrapper', 'horizontal-wrapper box-layout');
    </script>
  </body>
</html>