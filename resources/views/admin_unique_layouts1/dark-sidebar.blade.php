...
<html lang="en">
  <head>
    ...
    <title>optymoney - Premium Admin Template - Paris</title>
    <!-- Google font-->
  ...
  <body>
    ...
    <!-- tap on tap ends-->
    <!-- page-wrapper Start-->
    <div class="page-wrapper horizontal-wrapper dark-sidebar" id="pageWrapper">
      <!-- Page Header Start-->
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list">
                    <label class="badge badge-success">sdfsdfsd</label><a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}" href="#"><i data-feather="home"></i><span class="lan-3">{{ trans('lang.Dashboards') }}</span>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Copyright {{ date('Y') }} © Optymoney by skcores  </p>
              </div>
            </div>
          </div>
        </footer>
    ...
    <script type="text/javascript">
        localStorage.clear();
        $(".page-wrapper").attr("class", "page-wrapper horizontal-wrapper dark-sidebar");
        localStorage.setItem('page-wrapper', 'horizontal-wrapper dark-sidebar');
    </script>
  </body>
</html>