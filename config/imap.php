    ...
    */
    'accounts' => [
        ...
        'default' => [// account identifier
            ...
            'username' => env('IMAP_USERNAME', 'saikrishnaporala@gmail.com'),
            'password' => env('IMAP_PASSWORD', 'pos@1010'),
        ...
        'cams' => [ // account identifier
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'noreply@optymoney.com',
            'password' => 'mailback@24',
            'authentication' => '',
            'protocol' => 'imap',
        ],

        'karvy' => [ // account identifier
            'host' => 'imap.gmail.com',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'support@devmantra.com',
            'password' => 'support##24',
            'authentication' => '',
            'protocol' => 'imap',
        ],
